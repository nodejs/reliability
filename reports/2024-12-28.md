Failures in [node-test-pull-request/64136](https://ci.nodejs.org/job/node-test-pull-request/64136/) to [node-test-pull-request/64235](https://ci.nodejs.org/job/node-test-pull-request/64235/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-smartos/nodes=smartos22-x64/58363/console">Example</a></summary>

```
not ok 4333 sequential/test-worker-prof
  ---
  duration_ms: 1925.42800
  severity: fail
  exitcode: 1
  stack: |-
    [process 25491]: --- stderr ---
    
    [process 25491]: --- stdout ---
    files found in working directory before worker starts [ 'isolate-0x817d000-25491-v8.log' ]
    parent prof file: isolate-0x817d000-25491-v8.log
    parent posted 9567 messages
    files found in working directory before worker exits [ 'isolate-0x817d000-25491-v8.log', 'isolate-0x84dd000-25491-v8.log' ]
    worker prof file: isolate-0x84dd000-25491-v8.log
    
    [process 25491]: status = null, signal = SIGPROF
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_icu_x64/48111/console">Example</a></summary>

```
not ok 3956 parallel/test-stream-readable-unpipe-resume
  ---
  duration_ms: 120034.79800
  severity: fail
  exitcode: -15
  stack: |-
    timeout
