Failures in [node-test-pull-request/68676](https://ci.nodejs.org/job/node-test-pull-request/68676/) to [node-test-pull-request/68774](https://ci.nodejs.org/job/node-test-pull-request/68774/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm-debug/nodes=ubuntu2204_debug-arm64/19991/console">Example</a></summary>

```
not ok 3146 parallel/test-runner-mock-timers-scheduler
  ---
  duration_ms: 4235.13000
  severity: fail
  exitcode: 1
  stack: |-
...
| Appeared | [test-equinix-ubuntu2204_container-arm64-6](https://ci.nodejs.org/job/node-test-commit-arm/nodes=ubuntu2204-arm64/60012/console), [test-equinix-ubuntu2204_container-arm64-4](https://ci.nodejs.org/job/node-test-commit-arm-debug/nodes=ubuntu2204_debug-arm64/19991/console), [test-equinix-rhel8_container-arm64-2](https://ci.nodejs.org/job/node-test-commit-arm/nodes=rhel8-arm64/59948/console) |
| First CI | https://ci.nodejs.org/job/node-test-pull-request/68689/ |
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/68774/ |

<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm/nodes=ubuntu2204-arm64/60012/console">Example</a></summary>

```
not ok 1877 parallel/test-http-keep-alive-empty-line
  ---
  duration_ms: 1701.03000
  severity: fail
  exitcode: 1
  stack: |-
    node:events:486
...
```
not ok 1909 parallel/test-http-outgoing-end-cork
  ---
  duration_ms: 3750.82400
  severity: fail
  exitcode: 1
  stack: |-
    Sending req no 1
...
| - | :- |
| Type | JS_TEST_FAILURE |
| Failed PR | 3 ([https://github.com/nodejs/node/pull/59368/](https://ci.nodejs.org/job/node-test-pull-request/68702/), [https://github.com/nodejs/node/pull/59538/](https://ci.nodejs.org/job/node-test-pull-request/68747/), [https://github.com/nodejs/node/pull/59504/](https://ci.nodejs.org/job/node-test-pull-request/68763/)) |
| Appeared | [test-ibm-rhel8-s390x-4](https://ci.nodejs.org/job/node-test-commit-linuxone/nodes=rhel8-s390x/51158/console), [test-linuxonecc-rhel9-s390x-1](https://ci.nodejs.org/job/node-test-commit-linuxone/nodes=rhel9-s390x/51158/console), [test-ibm-rhel8-s390x-1](https://ci.nodejs.org/job/node-test-commit-linuxone/nodes=rhel8-s390x/51148/console), [test-ibm-rhel8-s390x-3](https://ci.nodejs.org/job/node-test-commit-linuxone/nodes=rhel8-s390x/51113/console), [test-linuxonecc-rhel9-s390x-4](https://ci.nodejs.org/job/node-test-commit-linuxone/nodes=rhel9-s390x/51113/console) |
| First CI | https://ci.nodejs.org/job/node-test-pull-request/68702/ |
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/68763/ |

<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linuxone/nodes=rhel8-s390x/51158/console">Example</a></summary>

```
not ok 4238 sequential/test-performance-eventloopdelay
  ---
  duration_ms: 14721.04400
  severity: fail
  exitcode: 1
  stack: |-
...
```
not ok 3165 parallel/test-runner-run
  ---
  duration_ms: 28776.29500
  severity: fail
  exitcode: 1
  stack: |-
    ...
    - 'testTimeoutFailure'
        ...
        at TestsStream.<anonymous> (file:///home/iojs/build/workspace/node-test-commit-arm-debug/test/parallel/test-runner-run.mjs:94:14)
        at TestsStream.<anonymous> (/home/iojs/build/workspace/node-test-commit-arm-debug/test/common/index.js:468:15)
        ...
        at FileTest.finalize (node:internal/test_runner/test:1...
```
</details>
