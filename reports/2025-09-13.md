Failures in [node-test-pull-request/69116](https://ci.nodejs.org/job/node-test-pull-request/69116/) to [node-test-pull-request/69215](https://ci.nodejs.org/job/node-test-pull-request/69215/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2025-09-13.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2025-09-13 00:10 | 1       | 18      | 20       | 1       | 60      | 18.37%     |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm/nodes=ubuntu2204-arm64/60331/console">Example</a></summary>

```
not ok 2953 parallel/test-runner-watch-mode-kill-signal
  ---
  duration_ms: 8826.49700
  severity: fail
  exitcode: 1
  stack: |-
    ...
    "Restarting '/home/iojs/node-tmp/.tmp.2931/index.js'\n" +
      '__SIGINT received__\n' +
      ...
      generatedMessage: true,
      code: 'ERR_ASSERTION',
      actual: "Restarting '/home/iojs/node-tmp/.tmp.2931/in...
```
</details>
