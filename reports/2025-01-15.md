Failures in [node-test-pull-request/64422](https://ci.nodejs.org/job/node-test-pull-request/64422/) to [node-test-pull-request/64515](https://ci.nodejs.org/job/node-test-pull-request/64515/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2025-01-15.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2025-01-15 00:09 | 0       | 21      | 23       | 6       | 50      | 22.34%     |
...
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/64487/ |

<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_shared_x64/48375/console">Example</a></summary>

```
not ok 2520 parallel/test-net-write-fully-async-hex-string
  ---
  duration_ms: 120108.59000
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-binary-windows-js-suites/RUN_SUBSET=2,nodes=win2022-COMPILED_BY-vs2022/32075/console">Example</a></summary>

```
not ok 984 parallel/test-net-write-fully-async-buffer
  ---
  duration_ms: 120252.94600
  severity: fail
  exitcode: 1
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_shared_x64/48380/console">Example</a></summary>

```
not ok 3840 es-module/test-wasm-web-api
  ---
  duration_ms: 867.63300
  severity: crashed
  exitcode: -11
  stack: |-
    (node:1444938) Warning: Closing file descriptor 27 on garbage collection
    (Use `node --trace-warnings ...` to show where the warning was created)
    (node:1444938) [DEP0137] DeprecationWarning: Closing a FileHandle object on garbage collection is deprecated. Please close FileHandle objects explicitly using FileHandle.prototype.close(). In the future, an error will be thrown if a file descriptor is closed during garbage collection.
    (node:1444938) Warning: Closing file descriptor 28 on garbage collection
  ...
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-compile-windows/nodes=win-vs2022-arm64/59858/console">Example</a></summary>

```
java.io.IOException: Backing channel 'JNLP4-connect connection from 104.239.143.77/104.239.143.77:61222' is disconnected.
