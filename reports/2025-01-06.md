Failures in [node-test-pull-request/64262](https://ci.nodejs.org/job/node-test-pull-request/64262/) to [node-test-pull-request/64355](https://ci.nodejs.org/job/node-test-pull-request/64355/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2025-01-06.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2025-01-06 00:10 | 8       | 11      | 18       | 5       | 58      | 12.64%     |
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/64265/ |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit/76835/console">Example</a></summary>
