Failures in [node-test-pull-request/73744](https://ci.nodejs.org/job/node-test-pull-request/73744/) to [node-test-pull-request/73842](https://ci.nodejs.org/job/node-test-pull-request/73842/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2026-06-01.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2026-06-01 00:37 | 0       | 21      | 21       | 9       | 49      | 23.08%     |
...
| - | :- |
| Type | BUILD_FAILURE |
| Failed PR | 2 ([https://github.com/nodejs/node/pull/63478/](https://ci.nodejs.org/job/node-test-pull-request/73751/), [https://github.com/nodejs/node/pull/63547/](https://ci.nodejs.org/job/node-test-pull-request/73760/)) |
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/73751/ |
