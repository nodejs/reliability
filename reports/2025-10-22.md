Failures in [node-test-pull-request/69750](https://ci.nodejs.org/job/node-test-pull-request/69750/) to [node-test-pull-request/69847](https://ci.nodejs.org/job/node-test-pull-request/69847/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2025-10-22.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2025-10-22 00:11 | 2       | 18      | 13       | 2       | 65      | 18.75%     |
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/69762/ |
