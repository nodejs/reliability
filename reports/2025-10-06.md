Failures in [node-test-pull-request/69475](https://ci.nodejs.org/job/node-test-pull-request/69475/) to [node-test-pull-request/69574](https://ci.nodejs.org/job/node-test-pull-request/69574/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=macos15-x64/67173/console">Example</a></summary>

```
not ok 4213 parallel/test-without-async-context-frame
  ---
  duration_ms: 120062.91700
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm/nodes=ubuntu2204-arm64/60617/console">Example</a></summary>

```
not ok 2952 parallel/test-runner-watch-mode-kill-signal
  ---
  duration_ms: 3928.55100
  severity: fail
  exitcode: 1
  stack: |-
    ...
    "Restarting '/home/iojs/node-tmp/.tmp.2948/index.js'\n" +
      ...
      code: 'ERR_ASSERTION',
      actual: "Restarting '/home/iojs/node-tmp/.tmp.2948/in...
```
</details>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-binary-windows-js-suites/RUN_SUBSET=2,nodes=win11-arm64-COMPILED_BY-vs2022_clang-arm64/37130/console">Example</a></summary>

```
not ok 1142 sequential/test-worker-prof
  ---
  duration_ms: 2718.00600
  severity: fail
  exitcode: 1
  stack: |-
    files found in working directory before worker starts [ 'isolate-000001F2E8014000-13804-v8.log' ]
    parent prof file: isolate-000001F2E8014000-13804-v8.log
    parent posted 37731 messages
    files found in working directory before worker exits [
      'isolate-000001F2E8014000-13804-v8.log',
      'isolate-000001F2F0D98000-13804-v8.log'
    ]
    worker prof file: isolate-000001F2F0D98000-13804-v8.log
    ...
    tick,0x7ff7bb7358e4,43014,0,0x0,2
    tick,0x7ff7bb7e5b2c,90993,0,0x0,0,0x2163ee96dd8,0x1f290082e90,0x1f2900829d4,0x2163ee969f0,0x2163ee8c516
    tick,0x7ff85ed6cb0c,378984,0,0x0,0,0x1f2900c0318,0x1f290048218,0x1f2900c0528
    tick,0x7ff85ed30e74,522980,0,0x0,0,0x1f2900c0318,0x1f290048218,0x1f2900c0528
    tick,0x7ff85ed3...
```
</details>
