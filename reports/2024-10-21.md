Failures in [node-test-pull-request/63124](https://ci.nodejs.org/job/node-test-pull-request/63124/) to [node-test-pull-request/63217](https://ci.nodejs.org/job/node-test-pull-request/63217/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2024-10-21.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2024-10-21 00:10 | 0       | 19      | 27       | 2       | 52      | 19.39%     |
...
| - | :- |
| Type | JS_TEST_FAILURE |
| Failed PR | 3 ([https://github.com/nodejs/node/pull/54862/](https://ci.nodejs.org/job/node-test-pull-request/63129/), [https://github.com/nodejs/node/pull/55471/](https://ci.nodejs.org/job/node-test-pull-request/63215/), [https://github.com/nodejs/node/pull/55412/](https://ci.nodejs.org/job/node-test-pull-request/63216/)) |
| Appeared | [test-ibm-rhel8-x64-1](https://ci.nodejs.org/job/node-test-commit-linux/nodes=rhel8-x64/61298/console), [test-ibm-ubuntu2204_sharedlibs_container-x64-2](https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_zlib_x64/46981/console) |
| First CI | https://ci.nodejs.org/job/node-test-pull-request/63129/ |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-linter/57306/console">Example</a></summary>

```
not ok 708 - /home/iojs/build/workspace/node-test-linter/lib/internal/modules/cjs/loader.js
  ---
  message: '''isUnderNodeModules'' is assigned a value but never used.'
  severity: error
  data:
    line: 127
    column: 3
