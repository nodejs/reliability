Failures in [node-test-pull-request/64127](https://ci.nodejs.org/job/node-test-pull-request/64127/) to [node-test-pull-request/64226](https://ci.nodejs.org/job/node-test-pull-request/64226/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2024-12-27.md`)
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx11-x64/62769/console">Example</a></summary>
