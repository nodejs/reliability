Failures in [node-test-pull-request/62768](https://ci.nodejs.org/job/node-test-pull-request/62768/) to [node-test-pull-request/62865](https://ci.nodejs.org/job/node-test-pull-request/62865/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_shared_x64/46741/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-cross-compile/nodes=cross-compiler-rhel9-armv7-gcc-12-glibc-2.28/50199/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm/nodes=rhel8-arm64/55143/console">Example</a></summary>

```
not ok 4088 parallel/test-stream-readable-unpipe-resume
  ---
  duration_ms: 360105.25400
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux/nodes=alpine-latest-x64/60949/console">Example</a></summary>

```
not ok 239 es-module/test-loaders-workers-spawned
  ---
  duration_ms: 1313.67700
  severity: fail
  exitcode: 1
  stack: |-
    ▶ Worker threads do not spawn infinitely
      ✔ should not trigger an infinite loop when using a loader exports no recognized hooks (279.970487ms)
      ✔ should support a CommonJS entry point and a loader that imports a CommonJS module (286.037528ms)
      ✔ should support --require and --import along with using a loader written in CJS and CJS entry point (234.025035ms)
      ✖ should support --require and --import along with using a loader written in ESM and ESM entry point (246.391137ms)
