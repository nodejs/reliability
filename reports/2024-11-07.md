Failures in [node-test-pull-request/63367](https://ci.nodejs.org/job/node-test-pull-request/63367/) to [node-test-pull-request/63460](https://ci.nodejs.org/job/node-test-pull-request/63460/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2024-11-07.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2024-11-07 00:09 | 3       | 8       | 34       | 2       | 53      | 8.42%      |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx-arm/nodes=osx11/17518/console">Example</a></summary>

```
not ok 4227 sequential/test-http-server-request-timeouts-mixed
  ---
  duration_ms: 3359.19800
  severity: fail
  exitcode: 1
  stack: |-
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/63380/ |
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/63447/ |

<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx-arm/nodes=osx11/17508/console">Example</a></summary>

```
not ok 4135 parallel/test-file-write-stream4
  ---
  duration_ms: 360068.92100
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/63377/ |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-binary-windows-js-suites/RUN_SUBSET=1,nodes=win10-COMPILED_BY-vs2022/31172/console">Example</a></summary>

```
not ok 600 parallel/test-os
  ---
  duration_ms: 140.00900
  severity: fail
  exitcode: 1
  stack: |-
    node:assert:90
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-binary-armv7l/RUN_SUBSET=js,nodes=ubuntu2204-armv7l/14491/console">Example</a></summary>
