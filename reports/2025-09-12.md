Failures in [node-test-pull-request/69107](https://ci.nodejs.org/job/node-test-pull-request/69107/) to [node-test-pull-request/69195](https://ci.nodejs.org/job/node-test-pull-request/69195/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-binary-windows-js-suites/RUN_SUBSET=3,nodes=win11-arm64-COMPILED_BY-vs2022_clang-arm64/36812/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx13-arm64/66745/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux/nodes=ubuntu2404-x64/66573/console">Example</a></summary>

```
java.io.IOException: Backing channel 'JNLP4-connect connection from 165.227.180.106/165.227.180.106:60264' is disconnected.
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux/nodes=ubuntu2404-x64/66576/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-plinux/nodes=rhel8-ppc64le/60763/console">Example</a></summary>

```
not ok 4303 client-proxy/test-https-proxy-request-invalid-char-in-url
  ---
  duration_ms: 265.33600
  severity: fail
  exitcode: 1
  stack: |-
    #6 eneded response for: 'https://local\rhost:34089/carriage-return-in-host'
    #5 eneded response for: 'https://local\nhost:34089/newline-in-host'
    #4 eneded response for: 'https://local\r\nhost:34089/crlf-in-host'
    #3 eneded response for: 'https://localhost:3\r4089/carriage-return-in-port'
    #2 eneded response for: 'https://localhost:3\n4089/newline-in-port'
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-aix/nodes=aix72-ppc64/58994/console">Example</a></summary>

```
not ok 4812 wpt/test-streams
  ---
  duration_ms: 1417.74500
  severity: crashed
  exitcode: -5
  stack: |-
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx13-x64/66717/console">Example</a></summary>

```
not ok 2788 parallel/test-runner-run-watch
  ---
  duration_ms: 30465.54700
  severity: fail
  exitcode: 1
  stack: |-
