Failures in [node-test-pull-request/65404](https://ci.nodejs.org/job/node-test-pull-request/65404/) to [node-test-pull-request/65499](https://ci.nodejs.org/job/node-test-pull-request/65499/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm/nodes=ubuntu2204-armv7l/57506/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx13-arm64/63970/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx13-x64/63964/console">Example</a></summary>

```
not ok 4369 sequential/test-perf-hooks
  ---
  duration_ms: 787.54100
  severity: fail
  exitcode: 1
  stack: |-
    ...
    AssertionError [ERR_ASSERTION]: Date.now() - performance.timeOrigin (394.39208984375) - process.uptime() * 1000 (295.33163) = 99.06045984374998 >= +- 50
