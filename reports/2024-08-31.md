Failures in [node-test-pull-request/61624](https://ci.nodejs.org/job/node-test-pull-request/61624/) to [node-test-pull-request/61718](https://ci.nodejs.org/job/node-test-pull-request/61718/) that failed 2 or more PRs
...
| - | :- |
| Type | BUILD_FAILURE |
| Failed PR | 2 ([https://github.com/nodejs/node/pull/54553/](https://ci.nodejs.org/job/node-test-pull-request/61633/), [https://github.com/nodejs/node/pull/54651/](https://ci.nodejs.org/job/node-test-pull-request/61712/)) |
| Appeared | [test-orka-macos11-x64-1](https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx11-x64/60900/console), [test-osuosl-rhel8-ppc64_le-4](https://ci.nodejs.org/job/node-test-commit-plinux/nodes=rhel8-ppc64le/55108/console) |
| First CI | https://ci.nodejs.org/job/node-test-pull-request/61633/ |
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/61712/ |

<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx11-x64/60900/console">Example</a></summary>
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/61631/ |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux/nodes=fedora-last-latest-x64/60090/console">Example</a></summary>

```
not ok 1117 parallel/test-esm-loader-hooks-inspect-wait
  ---
  duration_ms: 10582.01400
  severity: fail
  exitcode: 1
  stack: |-
    [test] Connecting to a child Node process
    [test] Testing /json/list
    [err] Debugger listening on ws://127.0.0.1:33473/2598c840-2c9e-4f9b-89d6-1b277340b88d
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-binary-windows-js-suites/RUN_SUBSET=3,nodes=win11-COMPILED_BY-vs2022/29752/console">Example</a></summary>

```
not ok 692 parallel/test-runner-watch-mode-complex
  ---
  duration_ms: 6611.15400
  severity: fail
  exitcode: 1
  stack: |-
    ▶ test runner watch mode with more complex setup
      ✖ should run tests when a dependency changed after a watched test file being deleted (5318.5508ms)
        AssertionError [ERR_ASSERTION]: The input did not match the regular expression /tests 2/. Input:
        
        '✔ second test has ran (9.9939ms)\n' +
          '✔ first test has ran (12.7993ms)\n' +
          '✔ second test has ran (18.8105ms)\n' +
          'ℹ tests 3\n' +
          'ℹ suites 0\n' +
          'ℹ pass 3\n' +
          'ℹ fail 0\n' +
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-plinux/nodes=rhel8-ppc64le/55146/console">Example</a></summary>

```
not ok 3738 parallel/test-sqlite-statement-sync
  ---
  duration_ms: 120100.15700
  severity: fail
  exitcode: -15
  stack: |-
    timeout
    (node:4084994) ExperimentalWarning: SQLite is an experimental feature and might change at any time
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_withoutintl_x64/45788/console">Example</a></summary>

```
not ok 948 parallel/test-dns
  ---
  duration_ms: 151.36500
  severity: fail
  exitcode: 1
  stack: |-
    (node:2632286) [DEP0118] DeprecationWarning: The provided hostname "" is not a valid hostname, and is supported in the dns module solely for compatibility.
...
```
not ok 1419 parallel/test-fs-watch-recursive-linux-parallel-remove
  ---
  duration_ms: 135694.57600
  severity: fail
  exitcode: -15
  stack: |-
    timeout
