Failures in [node-test-pull-request/65374](https://ci.nodejs.org/job/node-test-pull-request/65374/) to [node-test-pull-request/65471](https://ci.nodejs.org/job/node-test-pull-request/65471/) that failed 2 or more PRs
...
| - | :- |
| Type | BUILD_FAILURE |
| Failed PR | 2 ([https://github.com/nodejs/node/pull/57053/](https://ci.nodejs.org/job/node-test-pull-request/65390/), [https://github.com/nodejs/node/pull/57146/](https://ci.nodejs.org/job/node-test-pull-request/65471/)) |
| Appeared | [undefined](https://ci.nodejs.org/job/node-test-commit/78192/console) |
| First CI | https://ci.nodejs.org/job/node-test-pull-request/65390/ |
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/65471/ |

<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit/78192/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx13-x64/63938/console">Example</a></summary>

```
not ok 2575 parallel/test-runner-run-watch
  ---
  duration_ms: 26436.40900
  severity: fail
  exitcode: 1
  stack: |-
