Failures in [node-test-pull-request/66649](https://ci.nodejs.org/job/node-test-pull-request/66649/) to [node-test-pull-request/66747](https://ci.nodejs.org/job/node-test-pull-request/66747/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-custom-suites-freestyle/42124/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_openssl35_x64/50574/console">Example</a></summary>

```
not ok 4435 sequential/test-tls-session-timeout
  ---
  duration_ms: 172.75400
  severity: fail
  exitcode: 1
  stack: |-
    node:assert:94
