Failures in [node-test-pull-request/66479](https://ci.nodejs.org/job/node-test-pull-request/66479/) to [node-test-pull-request/66573](https://ci.nodejs.org/job/node-test-pull-request/66573/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_withoutintl_x64/50425/console">Example</a></summary>

```
not ok 4084 pummel/test-heapdump-worker
  ---
  duration_ms: 720047.19100
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_openssl30_x64/50423/console">Example</a></summary>

```
not ok 4085 pummel/test-heapdump-zlib
  ---
  duration_ms: 720115.54200
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_openssl32_x64/50414/console">Example</a></summary>

```
not ok 4436 sequential/test-tls-session-timeout
  ---
  duration_ms: 172.44300
  severity: fail
  exitcode: 1
  stack: |-
    node:assert:95
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-binary-windows-js-suites/RUN_SUBSET=3,nodes=win11-arm64-COMPILED_BY-vs2022_clang-arm64/33976/console">Example</a></summary>
