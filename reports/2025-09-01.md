Failures in [node-test-pull-request/68878](https://ci.nodejs.org/job/node-test-pull-request/68878/) to [node-test-pull-request/68976](https://ci.nodejs.org/job/node-test-pull-request/68976/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2025-09-01.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2025-09-01 00:13 | 0       | 5       | 30       | 4       | 61      | 5.21%      |
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/68881/ |
