Failures in [node-test-pull-request/67087](https://ci.nodejs.org/job/node-test-pull-request/67087/) to [node-test-pull-request/67186](https://ci.nodejs.org/job/node-test-pull-request/67186/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2025-05-30.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2025-05-30 00:11 | 0       | 20      | 17       | 1       | 62      | 20.20%     |
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/67088/ |
