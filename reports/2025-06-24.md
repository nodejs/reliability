Failures in [node-test-pull-request/67526](https://ci.nodejs.org/job/node-test-pull-request/67526/) to [node-test-pull-request/67627](https://ci.nodejs.org/job/node-test-pull-request/67627/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2025-06-24.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2025-06-24 00:11 | 0       | 1       | 23       | 6       | 70      | 1.06%      |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-binary-windows-js-suites/RUN_SUBSET=1,nodes=win11-COMPILED_BY-vs2019/34983/console">Example</a></summary>

```
not ok 974 pummel/test-string-decoder-large-buffer
  ---
  duration_ms: 159.00900
  severity: fail
  exitcode: 1
  stack: |-
...
| Appeared | [test-azure_msft-win11_vs2022-x64-1](https://ci.nodejs.org/job/node-test-binary-windows-js-suites/RUN_SUBSET=1,nodes=win11-COMPILED_BY-vs2019/34983/console), [test-digitalocean-rhel8-x64-1](https://ci.nodejs.org/job/node-test-commit-linux/nodes=rhel8-x64/65243/console) |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-plinux/nodes=rhel8-ppc64le/59592/console">Example</a></summary>

```
not ok 3899 parallel/test-worker-nearheaplimit-deadlock
  ---
  duration_ms: 622.37900
  severity: crashed
  exitcode: -6
  stack: |-
    ...
    [4137983:0x7fff4c010000]       13 ms: Mark-Compact 0.4 (3.0) -> 0.4 (3.0) MB, pooled: 0.0 MB, 0.90 / 0.00 ms (average mu = 0.526, current mu = 0.144) background allocation failure; GC in old space requested
    [4137983:0x7fff4c010000]       14 ms: Mark-Compact 0.4 (3.0) -> 0.4 (3.0) MB, pooled: 0.0 MB, 0.89 / 0.00 ms (average mu = 0.398, current mu = 0.129) background allocation failure; GC in old space requested
    
    FATAL ERROR: CALL_AND_RETRY_LAST Allocation failed - JavaScript heap out of memory
    ----- Native stack trace -----
    
     1: 0x10ac0cf0 node::OOMErrorHandler(char const*, v8::OOMDetails const&) [out/Release/node]
     2: 0x1104fecc v8::Utils::ReportOOMFailure(v8::internal::Isolate*, char const*, v8::OOMDetails const&) [out/Release/node]
     3: 0x11050020 v8::internal::V8::FatalProcessOutOfMemory(v8::internal::Is...
```
</details>
