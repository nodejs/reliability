Failures in [node-test-pull-request/63966](https://ci.nodejs.org/job/node-test-pull-request/63966/) to [node-test-pull-request/64065](https://ci.nodejs.org/job/node-test-pull-request/64065/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2024-12-16.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2024-12-16 00:11 | 0       | 15      | 19       | 8       | 58      | 16.30%     |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx11-x64/62599/console">Example</a></summary>

```
not ok 3949 parallel/test-watch-file-shared-dependency
  ---
  duration_ms: 120150.63600
  severity: fail
  exitcode: -15
  stack: |-
    timeout
    ▶ watch file with shared dependency
      ✔ should not remove shared dependencies when unfiltering an owner (13.999856ms)
    ✔ watch file with shared dependency (17.115882ms)
  ...
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/63967/ |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm/nodes=ubuntu2204-arm64/56239/console">Example</a></summary>

```
not ok 4179 parallel/test-stream-readable-unpipe-resume
  ---
  duration_ms: 360052.92600
  severity: fail
  exitcode: -15
  stack: |-
    timeout
