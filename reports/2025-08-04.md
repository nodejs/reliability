Failures in [node-test-pull-request/68291](https://ci.nodejs.org/job/node-test-pull-request/68291/) to [node-test-pull-request/68383](https://ci.nodejs.org/job/node-test-pull-request/68383/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm-debug/nodes=ubuntu2204_debug-arm64/19686/console">Example</a></summary>

```
not ok 4596 sequential/test-tls-session-timeout
  ---
  ...
  stack: |-
    ...
    'New' !== 'Reused'
        ...
        at /home/iojs/build/workspace/node-test-commit-arm-debug/test/sequential/test-tls-session-timeout.js:150:16
        at ChildProcess.<anonymous> (/home/iojs/build/workspace/node-test-commit-arm-debug/test/sequential/test-tls-session-timeout.js:134:7)
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-plinux/nodes=rhel8-ppc64le/60173/console">Example</a></summary>

```
not ok 4158 client-proxy/test-https-proxy-request-invalid-char-in-url
  ---
  duration_ms: 269.57700
  severity: fail
  exitcode: 1
  stack: |-
    #6 eneded response for: 'https://local\rhost:43611/carriage-return-in-host'
    #5 eneded response for: 'https://local\nhost:43611/newline-in-host'
    #4 eneded response for: 'https://local\r\nhost:43611/crlf-in-host'
    #3 eneded response for: 'https://localhost:4\r3611/carriage-return-in-port'
    #2 eneded response for: 'https://localhost:4\n3611/newline-in-port'
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux/nodes=rhel8-x64/65927/console">Example</a></summary>

```
not ok 4484 benchmark/test-benchmark-validators
  ---
  duration_ms: 274.65500
  severity: fail
  exitcode: 1
  stack: |-
    /home/iojs/build/workspace/node/benchmark/common.js:273
            throw new Error('insufficient clock precision for short benchmark');
            ^
    
    Error: insufficient clock precision for short benchmark
        at Benchmark.end (/home/iojs/build/workspace/node/benchmark/common.js:273:15)
        at main (/home/iojs/build/workspace/node/benchmark/validators/parse-file-mode.js:54:9)
        at /home/iojs/build/workspace/node/benchmark/common.js:63:9
