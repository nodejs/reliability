Failures in [node-test-pull-request/62971](https://ci.nodejs.org/job/node-test-pull-request/62971/) to [node-test-pull-request/63067](https://ci.nodejs.org/job/node-test-pull-request/63067/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2024-10-13.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2024-10-13 00:10 | 1       | 18      | 14       | 12      | 55      | 20.69%     |
...
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/63067/ |

<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux-containered/nodes=ubuntu2204_sharedlibs_shared_x64/46926/console">Example</a></summary>

```
not ok 4173 wpt/test-compression
  ---
  duration_ms: 1440161.16200
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-binary-windows-js-suites/RUN_SUBSET=3,nodes=win11-arm64-COMPILED_BY-vs2019-arm64/30796/console">Example</a></summary>

```
not ok 997 wpt/test-url
  ---
  duration_ms: 1487.84500
  severity: crashed
  exitcode: 3221225477
  stack: |-
    [SKIPPED] idlharness-shadowrealm.window.js: ShadowRealm support is not enabled
