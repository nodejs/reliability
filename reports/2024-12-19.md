Failures in [node-test-pull-request/64010](https://ci.nodejs.org/job/node-test-pull-request/64010/) to [node-test-pull-request/64099](https://ci.nodejs.org/job/node-test-pull-request/64099/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2024-12-19.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2024-12-19 00:10 | 8       | 15      | 12       | 16      | 49      | 19.74%     |
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/64013/ |
...
| Appeared | [test-orka-macos11-x64-2](https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx11-x64/62641/console), [test-macstadium-macos11.0-arm64-3](https://ci.nodejs.org/job/node-test-commit-osx-arm/nodes=osx11/18147/console) |
| First CI | https://ci.nodejs.org/job/node-test-pull-request/64035/ |
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/64099/ |

<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx11-x64/62641/console">Example</a></summary>

```
not ok 3953 parallel/test-watch-file-shared-dependency
  ---
  duration_ms: 120040.51300
  severity: fail
  exitcode: -15
  stack: |-
    timeout
    ▶ watch file with shared dependency
      ✔ should not remove shared dependencies when unfiltering an owner (16.115313ms)
    ✔ watch file with shared dependency (19.265558ms)
  ...
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/64023/ |
