Failures in [node-test-pull-request/69578](https://ci.nodejs.org/job/node-test-pull-request/69578/) to [node-test-pull-request/69676](https://ci.nodejs.org/job/node-test-pull-request/69676/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-pull-request/69654/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-binary-windows-js-suites/RUN_SUBSET=0,nodes=win11-COMPILED_BY-vs2022_clang/37214/console">Example</a></summary>

```
not ok 1144 sequential/test-worker-prof
  ---
  duration_ms: 2615.11200
  severity: fail
  exitcode: 1
  stack: |-
    files found in working directory before worker starts [ 'isolate-000002317F91B000-10232-v8.log' ]
    parent prof file: isolate-000002317F91B000-10232-v8.log
    parent posted 29484 messages
    files found in working directory before worker exits [
      'isolate-000002311AB39000-10232-v8.log',
      'isolate-000002317F91B000-10232-v8.log'
    ]
    worker prof file: isolate-000002311AB39000-10232-v8.log
    ...
    tick,0x7ff7aa01bdf6,231945,0,0x0,0,0x2311b6404be,0x2311b640287,0x3c853d8f992,0x2311b64058f,0x2311b640287,0x3c853d8e344,0x2311b64058f,0x2311b640287,0x14129d7e893,0x14129d7f0c7,0x3c853d8ca90,0x3c853d8c950,0x2311b64058f,0x2311b640287,0x3c853d8c6ad,0x2311b64058f,0x2311b640287,0x3c853d8bea7,0x2311b64058f,0x1b7d0004c4c,0x14129d...
```
</details>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=macos15-x64/67294/console">Example</a></summary>

```
not ok 2308 parallel/test-http2-close-while-writing
  ---
  duration_ms: 120127.19300
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=macos15-x64/67275/console">Example</a></summary>

```
not ok 4762 sequential/test-perf-hooks
  ---
  duration_ms: 715.25500
  severity: fail
  exitcode: 1
  stack: |-
    node:internal/assert/utils:77
    ...
    AssertionError [ERR_ASSERTION]: Date.now() - performance.timeOrigin (145.31591796875) - process.uptime() * 1000 (71.132524) = 74.18339396875 >= +- 50
...
```
not ok 3242 parallel/test-runner-watch-mode-kill-signal
  ---
  duration_ms: 120063.18100
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=macos15-x64/67273/console">Example</a></summary>

```
not ok 2758 parallel/test-runner-output
  ---
  duration_ms: 11614.31600
  severity: fail
  exitcode: 1
  stack: |-
