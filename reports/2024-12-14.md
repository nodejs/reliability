Failures in [node-test-pull-request/63951](https://ci.nodejs.org/job/node-test-pull-request/63951/) to [node-test-pull-request/64047](https://ci.nodejs.org/job/node-test-pull-request/64047/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2024-12-14.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2024-12-14 00:10 | 2       | 16      | 18       | 6       | 58      | 17.39%     |
...
| First CI | https://ci.nodejs.org/job/node-test-pull-request/63952/ |
...
| Failed PR | 2 ([https://github.com/nodejs/node/pull/56187/](https://ci.nodejs.org/job/node-test-pull-request/63951/), [https://github.com/nodejs/node/pull/55620/](https://ci.nodejs.org/job/node-test-pull-request/64037/)) |
| Appeared | [test-orka-macos11-x64-1](https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx11-x64/62565/console) |
| First CI | https://ci.nodejs.org/job/node-test-pull-request/63951/ |
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/64037/ |

<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx11-x64/62565/console">Example</a></summary>
