Failures in [node-test-pull-request/70564](https://ci.nodejs.org/job/node-test-pull-request/70564/) to [node-test-pull-request/70657](https://ci.nodejs.org/job/node-test-pull-request/70657/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2026-01-04.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2026-01-04 00:13 | 6       | 9       | 34       | 11      | 40      | 10.84%     |
...
| - | :- |
| Type | JS_TEST_FAILURE |
| Failed PR | 2 ([https://github.com/nodejs/node/pull/61192/](https://ci.nodejs.org/job/node-test-pull-request/70618/), [https://github.com/nodejs/node/pull/58708/](https://ci.nodejs.org/job/node-test-pull-request/70656/)) |
...
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/70656/ |
