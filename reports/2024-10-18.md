Failures in [node-test-pull-request/63070](https://ci.nodejs.org/job/node-test-pull-request/63070/) to [node-test-pull-request/63167](https://ci.nodejs.org/job/node-test-pull-request/63167/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2024-10-18.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2024-10-18 00:09 | 0       | 22      | 23       | 3       | 52      | 22.68%     |
...
| Last CI | https://ci.nodejs.org/job/node-test-pull-request/63167/ |
