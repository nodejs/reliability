Failures in [node-test-pull-request/62739](https://ci.nodejs.org/job/node-test-pull-request/62739/) to [node-test-pull-request/62833](https://ci.nodejs.org/job/node-test-pull-request/62833/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linuxone/nodes=rhel8-s390x/46131/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux/nodes=fedora-latest-x64/60921/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux/nodes=debian10-x64/60934/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-linter/57000/console">Example</a></summary>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux/nodes=alpine-latest-x64/60936/console">Example</a></summary>

```
not ok 237 es-module/test-loaders-workers-spawned
  ---
  duration_ms: 1418.85400
  severity: fail
  exitcode: 1
  stack: |-
    ▶ Worker threads do not spawn infinitely
      ✔ should not trigger an infinite loop when using a loader exports no recognized hooks (261.577355ms)
      ✔ should support a CommonJS entry point and a loader that imports a CommonJS module (365.890964ms)
      ✔ should support --require and --import along with using a loader written in CJS and CJS entry point (253.108572ms)
      ✖ should support --require and --import along with using a loader written in ESM and ESM entry point (256.04669ms)
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm/nodes=ubuntu2204-arm64/55118/console">Example</a></summary>

```
not ok 4104 parallel/test-stream-readable-unpipe-resume
  ---
  duration_ms: 360040.00700
  severity: fail
  exitcode: -15
  stack: |-
    timeout
