Failures in [node-test-pull-request/64444](https://ci.nodejs.org/job/node-test-pull-request/64444/) to [node-test-pull-request/64539](https://ci.nodejs.org/job/node-test-pull-request/64539/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2025-01-17.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2025-01-17 00:10 | 0       | 22      | 24       | 5       | 49      | 23.16%     |
...
```
not ok 747 parallel/test-buffer-tostring-rangeerror
  ---
  duration_ms: 120057.12600
  severity: fail
  exitcode: -15
  stack: |-
    timeout
    (node:3194084) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
    (Use `node --trace-deprecation ...` to show where the warning was created)
    (node:3194084) [DEP0030] DeprecationWarning: SlowBuffer() is deprecated. Please use Buffer.allocUnsafeSlow()
  ...
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm/nodes=rhel8-arm64/56686/console">Example</a></summary>

```
not ok 4059 parallel/test-file-write-stream4
  ---
  duration_ms: 360091.23300
  severity: fail
  exitcode: -15
  stack: |-
    timeout
