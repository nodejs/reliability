Failures in [node-test-pull-request/69216](https://ci.nodejs.org/job/node-test-pull-request/69216/) to [node-test-pull-request/69314](https://ci.nodejs.org/job/node-test-pull-request/69314/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-arm/nodes=ubuntu2204-arm64/60452/console">Example</a></summary>

```
not ok 2941 parallel/test-runner-watch-mode-kill-signal
  ---
  duration_ms: 814.53700
  severity: fail
  exitcode: 1
  stack: |-
    ...
    "Restarting '/home/iojs/node-tmp/.tmp.2940/index.js'\n" +
      '__SIGINT received__\n' +
      ...
      code: 'ERR_ASSERTION',
      actual: "Restarting '/home/iojs/node-tmp/.tmp.2940/ind...
```
</details>
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linuxone/nodes=rhel8-s390x/51653/console">Example</a></summary>

```
not ok 4600 sequential/test-performance-eventloopdelay
  ---
  duration_ms: 14719.89300
  severity: fail
  exitcode: 1
  stack: |-
