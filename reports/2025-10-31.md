Failures in [node-test-pull-request/69864](https://ci.nodejs.org/job/node-test-pull-request/69864/) to [node-test-pull-request/69963](https://ci.nodejs.org/job/node-test-pull-request/69963/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2025-10-31.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2025-10-31 00:11 | 0       | 21      | 18       | 0       | 61      | 21.00%     |
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-aix/nodes=aix72-ppc64/59591/console">Example</a></summary>

```
not ok 4624 addons/stringbytes-external-exceed-max/test-stringbytes-external-exceed-max-by-2
  ---
  duration_ms: 120158.20500
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-linux/nodes=rhel8-x64/67181/console">Example</a></summary>

```
not ok 2860 parallel/test-perf-hooks-timerify
  ---
  duration_ms: 234.96400
  severity: fail
  exitcode: 1
  stack: |-
