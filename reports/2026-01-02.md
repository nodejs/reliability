Failures in [node-test-pull-request/70548](https://ci.nodejs.org/job/node-test-pull-request/70548/) to [node-test-pull-request/70646](https://ci.nodejs.org/job/node-test-pull-request/70646/) that failed 2 or more PRs
(Generated with `ncu-ci walk pr --stats=true --markdown reports/2026-01-02.md`)

| UTC Time         | RUNNING | SUCCESS | UNSTABLE | ABORTED | FAILURE | Green Rate |
| ---------------- | ------- | ------- | -------- | ------- | ------- | ---------- |
| 2026-01-02 00:12 | 0       | 14      | 33       | 10      | 43      | 15.56%     |
