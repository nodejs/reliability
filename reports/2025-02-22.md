Failures in [node-test-pull-request/65270](https://ci.nodejs.org/job/node-test-pull-request/65270/) to [node-test-pull-request/65369](https://ci.nodejs.org/job/node-test-pull-request/65369/) that failed 2 or more PRs
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx13-arm64/63841/console">Example</a></summary>

```
not ok 4149 parallel/test-file-write-stream4
  ---
  duration_ms: 360036.04200
  severity: fail
  exitcode: -15
  stack: |-
    timeout
...
<details>
<summary><a href="https://ci.nodejs.org/job/node-test-commit-osx/nodes=osx13-x64/63835/console">Example</a></summary>

```
not ok 2580 parallel/test-runner-run-watch
  ---
  duration_ms: 26717.39700
  severity: fail
  exitcode: 1
  stack: |-
